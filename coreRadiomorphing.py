...
from interpolation_test_new import test_interpolation
...
# =============================================================================
        ...
        efield_interpolated = do_interpolation_hdf5(TargetShower, VoltageTraces = None, \
        ...
        print("efield_core.txt", max(abs(efield_interpolated[0][2])))
        
        error_peak = test_interpolation(SimulatedShower.traces,  efield_interpolated)
